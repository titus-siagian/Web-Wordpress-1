...
<?php   
    aiPostboxOpen("id-files-include", "Include content from an iframe from the same domain directly", $closedArray);  
?>
 <p>
...
if ($evanto || $isDemo) {
	aiPostboxOpen("id-file-parent", "Include html directly", $closedArray);  
	echo '<table class="form-table">';
